...
public class KeyCloakAdminService {
    ...
    private String keyloakServerUrl;
    ...
    public String getAdminAccessToken(){
        ...
        String url = keyloakServerUrl + "/realms/" +realm + "/protocol/openid-connect/token";
    ...
    public String createUser(String token, UserRequest userRequest) {
        ...
        String url = keyloakServerUrl + "/admin/realms/" + realm + "/users";
